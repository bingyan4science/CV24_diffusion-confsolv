...
def parse_train_args():
    ...
    parser.add_argument('--cache', type=str, default=f'data/{DTST}/cache', help='Folder from where to load/restore cached dataset')
    parser.add_argument('--data_dir', type=str, default=f'data/{DTST}/{dtst}/', help='Folder containing original conformers')
    parser.add_argument('--std_pickles', type=str, default='data/{DTST}/standardized_pickles', help='Folder in which the pickle are put after standardisation/matching')
    parser.add_argument('--split_path', type=str, default='data/{DTST}/split.npy', help='Path of file defining the split')
    parser.add_argument('--dataset', type=str, default=f'{dtst}', help='drugs or qm9')
